...
# Windows Maintenance and Troubleshooting Scripts
...
- **Create_Restore_Point_Command.txt**: Instructions for creating a system restore point using the Windows GUI.
...
## Video Demo Outline
1. **Introduction:**
   - Briefly explain why securing your PC and accounts is essential.

2. **Walkthrough:**
   - Demonstrate batch scripts for cleaning the PC.
   - Show the GUI method for creating a restore point.
   - Explain and demonstrate Google account security steps.

3. **Tips for Enhanced Security:**
   - Discuss the importance of regular maintenance, reviews, and using a password manager.
